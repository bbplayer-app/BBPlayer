...
SELECT id,channel,runtime_version,message,created_at,source,fingerprint_hash FROM update_groups ORDER BY created_at DESC LIMIT sqlc.arg('limit') OFFSET sqlc.arg('offset');
