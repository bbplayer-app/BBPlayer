...
function DialogTitle({
	...
	return (
		<DialogPrimitive.Title
			...
			className={cn(
				'font-heading text-lg font-medium leading-none text-foreground',
				className,
			)}
			{...props}
		/>
